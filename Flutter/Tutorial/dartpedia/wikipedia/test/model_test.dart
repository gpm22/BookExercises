...
void main() {
  group('deserialize example JSON responses from wikipedia API.', () {
    test(
      'deserialize Dart Programming Language page summary exmaple data from json file into a Summary object',
      () async {
    ...
    test(
      ...
      () async {
        ...
        final Map<String, Object?> articletMap =
            jsonDecode(articleJson) as Map<String, Object?>;

        final Map<String, Object?> pagesMap =
            (articletMap['query'] as Map)['pages'] as Map<String, Object?>;
