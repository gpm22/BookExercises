...
class MCState:
	def __init__(self, missionaries: int, cannibals: int, boat: bool) ->	None:
		...
		self.em: int = Missionarios - self.wm # east bank missionaries
		self.ec: int = Canibais - self.wc # east bank cannibals
		self.boat: bool = boat
...
.format(self.wm, self.wc, self.em, self.ec, ("west" if self.boat else "east"))
	...
	def goal_test(self) -> bool:
		return self.is_legal and self.em == Missionarios and self.ec == Canibais
...
if __name__ == "__main__":
	...
	start: MCState = MCState(Missionarios, Canibais, True)
